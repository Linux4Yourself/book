...
Можно также воспользоваться файлом <a href="../packages/core/wget-list.orig">wget-list.orig</a> который содержит аналогичные ссылки, но только с ресурсов репозиториев и хранилищ самих пакетов.
